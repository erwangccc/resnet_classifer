...
if __name__=='__main__':
    ...
    parser.add_argument("--batch_size", type=int, default = 1, help= "batch sizes when testing")
    parser.add_argument("--n_cpu", type=int, default = 8, help= "cpu number we used when testing")
